	...
	<form action="<%=context %>/from/cart_post!postOrder" method="post">
		...
		<TABLE cellSpacing=0 cellPadding=0 width=500 align=center border=0>
			<TBODY>
				<TR>
					...
					<TD width=383><INPUT value="${sessionScope.user.name }"
						name="name"></TD>
				</TR>
				<TR>
					<TD height=24>地址：</TD>
					<TD><INPUT value="${sessionScope.user.address }"
						name="address"></TD>
				</TR>
				<TR>
					<TD height=24>邮政编码：</TD>
					<TD><INPUT value="${sessionScope.user.postCode }"
						name="postCode"></TD>
				</TR>
				<TR>
					<TD height=23>E-mail：</TD>
					<TD><INPUT value="${sessionScope.user.email }" name="email">
					</TD>
				</TR>
				<TR>
					<TD height=23>联系电话：</TD>
					<TD><INPUT value="${sessionScope.user.cellPhone }"
						name="phone"></TD>
				</TR>
			</TBODY>
		</TABLE>
		...
		<TABLE cellSpacing=0 cellPadding=0 width=500 align=center border=0>
			<TBODY>
				<TR>
					<TD align=middle>
						<!-- <INPUT type=submit value=结帐 name=Submit> --> <input
						type="submit" value="结帐">
					</TD>
					...
					<TD align=middle><INPUT
						...
						type=button value="回到购物车" name=Submit42></TD>
				</TR>
			</TBODY>
		</TABLE>
	</form>
